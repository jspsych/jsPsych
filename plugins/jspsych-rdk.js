...
jsPsych.plugins["rdk"] = (function () {
    ...
    plugin.info = {
        ...
        parameters: {
            ...
            // aperture_center_x and aperture_center_y are set in the "Set Parameters Begin" section immediately below this section.
            // This is because if we set it here, the RDK will not be centered if we change the window size between trials.
            // Thank you to @liningpan (https://github.com/liningpan) for pointing this out.
            aperture_center_x: {
                type: jsPsych.plugins.parameterType.INT,
    ...
    plugin.trial = function (display_element, trial) {
        ...
        */
        ...
        //Declare the x and y jump sizes for coherent dots
        var coherentJumpSizeX;
        var coherentJumpSizeY;

        //Declare the number of coherent, opposite coherent, and incoherent dots
        var nCoherentDots;
        var nOppositeCoherentDots;
        var nIncoherentDots;

        //Declare the array of arrays containing dot objects
        var dotArray2d;
        ...
        function animateDotMotion() {
            ...
            function animate() {
                ...
                }//End of if (stopDotMotion)
            }//End of animate()
        }//End of animateDotMotion()
