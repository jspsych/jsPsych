...
save_at_end | boolean | `true` | Whether to submit the complete dataset when the experiment ends. Set to `false` if you would rather place a `jsPsychPipe` save trial in your timeline yourself.
