...
var instructions = {
  ...
  stimulus: `
    ...
    press the letter <kbd>F</kbd> on the keyboard as fast as you can.</p>
    <p>If the circle is <strong>orange</strong>, press the letter <kbd>J</kbd> 
    as fast as you can.</p>
    <div style='width: 700px;'>
    <div style='float: left;'><img src='img/blue.png'></img>
    <p class='small'><strong>Press the <kbd>F</kbd> key</strong></p></div>
    <div style='float: right;'><img src='img/orange.png'></img>
    <p class='small'><strong>Press the <kbd>J</kbd> key</strong></p></div>
    </div>
