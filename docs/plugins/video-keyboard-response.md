...
Current version: 2.2.0. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-video-keyboard-response/CHANGELOG.md).
...
```js
<script src="https://unpkg.com/@jspsych/plugin-video-keyboard-response@2.2.0"></script>
```
