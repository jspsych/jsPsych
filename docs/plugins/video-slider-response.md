...
slider_enabled_after_stop | boolean | false | If true, it enables the slider after the 'stop' time point is reached. This is useful in case response_ends_trial is true and response_allowed_while_playing is false, and you wish to end the trial after the participant responds to the part of the video that ends at 'stop'.
