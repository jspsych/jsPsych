...
[jspsych&#8209;psychophysics](/plugins/jspsych-psychophysics) | For displaying multiple stimuli asynchronously in a trial. The stimuli are synchronized with the refresh of the display using the requestAnimationFrame method. 
