...
enable_button_after | numeric | null | How long the button will delay enabling in milliseconds. If `response_allowed_while_playing` is set, the timer will start immediately. If not set, the timer will start at the end of the video.
