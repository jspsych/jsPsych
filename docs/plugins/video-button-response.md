...
Current version: 9.9.9. [See version history](https://github.com/jspsych/jsPsych/blob/main/packages/plugin-video-button-response/CHANGELOG.md).
...
```js
<script src="https://unpkg.com/@jspsych/plugin-video-button-response@9.9.9"></script>
```
