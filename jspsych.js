...
jsPsych.pluginAPI = (function() {
  ...
  module.autoPreload = function(timeline, callback, images, audio, progress_bar) {
    ...
    if(progress_bar){
      var pb_html = "<div id='jspsych-loading-progress-bar-container' style='height: 20px; width: 200px; background-color: #666;'>";
      pb_html += "<div id='jspsych-loading-progress-bar' style='height: 20px; width: 0%; background-color: #ddd;'></div>";
      pb_html += "</div>";
