...
plugin.info = {
  ...
  parameters: {
    ...
    change_border_background_color: {
      ...
      default: true,
      description:
        "If true, the sort area border color will change while items are being moved in and out of " +
    ...
    border_width: {
      ...
      default: null,
      description:
        "The width in pixels of the border around the sort area. If null, the border width " +
...
plugin.trial = function (display_element, trial) {
  ...
  if (trial.border_width == null) {
    trial.border_width = trial.sort_area_height * 0.03;
  }
