var jsPsychWebgazerInitCamera=(function(o){"use strict";var d="2.1.0";const p={name:"webgazer-init-camera",version:d,parameters:{instructions:{type:o.ParameterType.HTML_STRING,default:`
            ...
            <p>When your face is centered in the box and the box is green, you can click to continue.</p>`},button_text:{type:o.ParameterType.STRING,default:"Continue"}},data:{load_time:{type:o.ParameterType.INT}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class n{constructor(r){this.jsPsych=r}trial(r,s,y){const t=this.jsPsych.extensions.webgazer;let i;var h=performance.now(),c;const b=()=>{t.pause(),t.hideVideo();var e={load_time:c};document.querySelector("#webgazer-center-style").remove(),this.jsPsych.finishTrial(e),i()},u=()=>{y(),c=Math.round(performance.now()-h);var e=`
        ...
        `;document.querySelector("head").insertAdjacentHTML("beforeend",e);var l=`
          ...
          </div>`;r.innerHTML=l,t.showVideo(),t.resume();var w=r.querySelector("#webgazer-init-container");if(w.innerHTML=`
          ...
          </div>`,m())document.querySelector("#jspsych-wg-cont").disabled=!1;else{var a=new MutationObserver(g);a.observe(document,{attributes:!0,attributeFilter:["style"],subtree:!0})}document.querySelector("#jspsych-wg-cont").addEventListener("click",()=>{a&&a.disconnect(),b()})};t.isInitialized()?u():t.start().then(()=>{u()}).catch(e=>{console.log(e),r.innerHTML=`<p>The experiment cannot continue because the eye tracker failed to start.</p>
