...
declare const info: {
    readonly name: "categorize-image";
    ...
    readonly parameters: {
        ...
        readonly incorrect_text: {
            readonly type: ParameterType.HTML_STRING;
            readonly default: "<p class='feedback'>Wrong</p>";
        };
 ...
 */
declare class CategorizeImagePlugin implements JsPsychPlugin<Info> {
    private jsPsych;
    static info: {
        readonly name: "categorize-image";
        readonly version: string;
...
export { CategorizeImagePlugin as default };
