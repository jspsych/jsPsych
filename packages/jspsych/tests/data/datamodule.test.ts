...
describe("#displayData", () => {
  ...
  test("should display in csv format", async () => {
    ...
    expect(getHTML()).toMatch(
      /<pre id="jspsych-data-display">"rt","stimulus","response","rt_key_duration","trial_type","trial_index","plugin_version","time_elapsed"\r\n"[\d]+","hello","a","null","html-keyboard-response","0","[\d.]+","[\d]+"\r\n<\/pre>/
    );
  });
});
