var jsPsychModule=function($){"use strict";var D=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{};function X(r){return r&&r.__esModule&&Object.prototype.hasOwnProperty.call(r,"default")?r.default:r}const Je=r=>{const e=new Set;do for(const t of Reflect.ownKeys(r))e.add([r,t]);while((r=Reflect.getPrototypeOf(r))&&r!==Object.prototype);return e};var We=(r,{include:e,exclude:t}={})=>{const n=s=>{const l=u=>typeof u=="string"?s===u:u.test(s);return e?e.some(l):t?!t.some(l):!0};for(const[s,l]of Je(r.constructor.prototype)){if(l==="constructor"||!n(l))continue;const u=Reflect.getOwnPropertyDescriptor(s,l);u&&typeof u.value=="function"&&(r[l]=r[l].bind(r))}return r},U=X(We),Ye="8.2.3",ge=(r,e,t)=>new Promise((n,s)=>{var l=i=>{try{a(t.next(i))}catch(o){s(o)}},u=i=>{try{a(t.throw(i))}catch(o){s(o)}},a=i=>i.done?n(i.value):Promise.resolve(i.value).then(l,u);a((t=t.apply(r,e)).next())});class K{constructor(e,t){this.dependencies=e,this.extensionsConfiguration=t,this.extensions=Object.fromEntries(t.map(n=>[K.getExtensionNameByClass(n.type),this.dependencies.instantiateExtension(n.type)]))}static getExtensionNameByClass(e){return e.info.name}getExtensionInstanceByClass(e){return this.extensions[K.getExtensionNameByClass(e)]}initializeExtensions(){return ge(this,null,function*(){yield Promise.all(this.extensionsConfiguration.map(({type:e,params:t={}})=>{this.getExtensionInstanceByClass(e).initialize(t);const n=e.info;!("version"in n)&&!("data"in n)?console.warn(n.name,"is missing the 'version' and 'data' fields. Please update extension as 'version' and 'data' will be required in v9. See https://www.jspsych.org/latest/developers/extension-development/ for more details."):"version"in n?"data"in n||console.warn(n.name,"is missing the 'data' field. Please update extension as 'data' will be required in v9. See https://www.jspsych.org/latest/developers/extension-development/ for more details."):console.warn(n.name,"is missing the 'version' field. Please update extension as 'version' will be required in v9. See https://www.jspsych.org/latest/developers/extension-development/ for more details.")}))})}onStart(e=[]){var t;for(const{type:n,params:s}of e)(t=this.getExtensionInstanceByClass(n))==null||t.on_start(s)}onLoad(e=[]){var t;for(const{type:n,params:s}of e)(t=this.getExtensionInstanceByClass(n))==null||t.on_load(s)}onFinish(){return ge(this,arguments,function*(e=[]){const t=yield Promise.all(e.map(({type:s,params:l})=>{var u;return Promise.resolve((u=this.getExtensionInstanceByClass(s))==null?void 0:u.on_finish(l))})),n=e.length?{extension_type:e.map(({type:s})=>s.info.name),extension_version:e.map(({type:s})=>s.info.version)}:{};return t.unshift(n),Object.assign({},...t)})}}function G(r){return[...new Set(r)]}function A(r){if(!r)return r;let e;if(Array.isArray(r)){e=[];for(const t of r)e.push(A(t));return e}else if(typeof r=="object"&&r!==null){e={};for(const t in r)r.hasOwnProperty(t)&&(e[t]=A(r[t]));return e}else return r}function F(r,e){let t={};for(const n in r)r.hasOwnProperty(n)&&(typeof r[n]=="object"&&e.hasOwnProperty(n)?t[n]=F(r[n],e[n]):t[n]=r[n]);for(const n in e)e.hasOwnProperty(n)&&(t.hasOwnProperty(n)&&typeof e[n]=="object"?t[n]=F(t[n],e[n]):t[n]=e[n]);return t}var Xe=Object.freeze({__proto__:null,deepCopy:A,deepMerge:F,unique:G});class H{constructor(e=[]){this.values=e}sum(){let e=0;for(const t of this.values)e+=t;return e}mean(){let e=0,t=0;for(const n of this.values)typeof n!="undefined"&&n!==null&&(e+=n,t++);if(t!==0)return e/t}median(){if(this.values.length===0)return;const e=this.values.slice(0).sort(function(n,s){return n-s}),t=Math.floor(e.length/2);return e.length%2===0?(e[t]+e[t-1])/2:e[t]}min(){return Math.min.apply(null,this.values)}max(){return Math.max.apply(null,this.values)}count(){return this.values.length}variance(){const e=this.mean();let t=0;for(const n of this.values)t+=Math.pow(n-e,2);return t/(this.values.length-1)}sd(){const e=this.variance();return Math.sqrt(e)}frequencies(){const e={};for(const t of this.values)typeof e[t]=="undefined"?e[t]=1:e[t]++;return e}all(e){for(const t of this.values)if(!e(t))return!1;return!0}subset(e){const t=[];for(const n of this.values)e(n)&&t.push(n);return new H(t)}}function He(r,e){const t=new Blob([r],{type:"text/plain"});let n="";typeof window.webkitURL!="undefined"?n=window.webkitURL.createObjectURL(t):n=window.URL.createObjectURL(t);const s=document.createElement("a");s.id="jspsych-download-as-text-link",s.style.display="none",s.download=e,s.href=n,s.click()}function Qe(r){const e=typeof r!="object"?JSON.parse(r):r;let t="",n="";const s=[];for(const l of e)for(const u in l){let a=u+"";a='"'+a.replace(/"/g,'""')+'",',s.includes(u)||(s.push(u),t+=a)}t=t.slice(0,-1),n+=t+`\r
