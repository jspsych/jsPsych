...
declare class MultiplayerAPI {
     ...
     */
    wait(condition: (data: GroupSessionData) => boolean, timeout?: number | null): Promise<GroupSessionData>;
    /**
...
export { DataCollection, type GroupSessionData, JsPsych, type JsPsychExtension, type JsPsychExtensionInfo, type JsPsychPlugin, type MultiplayerAdapter, MultiplayerCancelledError, MultiplayerTimeoutError, ParameterType, type PluginInfo, type TrialType, type Unsubscribe, initJsPsych };
