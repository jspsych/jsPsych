...
declare class MultiplayerAPI {
     ...
     * multiplayer method.
     */
    connect(adapter: MultiplayerAdapter): Promise<void>;
     ...
     */
    communicate(data: Record<string, unknown>, condition: (groupData: GroupSessionData) => boolean, timeout?: number): Promise<GroupSessionData>;
    /**
...
declare function createJointPluginAPIObject(jsPsych: JsPsych): KeyboardListenerAPI & TimeoutAPI & MediaAPI & SimulationAPI & MultiplayerAPI;
...
export { DataCollection, type GroupSessionData, JsPsych, type JsPsychExtension, type JsPsychExtensionInfo, type JsPsychPlugin, type MultiplayerAdapter, ParameterType, type PluginInfo, type TrialType, type Unsubscribe, initJsPsych };
