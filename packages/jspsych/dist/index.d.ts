...
interface ViewportChange extends ViewportState {
    t: number;
}
...
type RecordedEvent = DomMutation | InputRecord | ClipboardRecord | MediaRecord | FocusRecord | ScrollRecord | CanvasSnapshot;
type DomMutation = {
    type: "dom.add";
    t: number;
    parent: number;
...
declare class JsPsych {
     ...
     * ```
     */
    getSessionRecordingCompressed(): Promise<Blob | undefined>;
