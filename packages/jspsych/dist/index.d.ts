...
type SessionLogEntryType = SessionLogEntry["type"];
...
interface SessionRecorderOptions extends ResumeOptions {
...
declare class SessionRecorder {
    ...
    private readonly incompletePolicy;
    private readonly completedPolicy;
    private readonly getElapsedTime;
    private readonly onReplayComplete?;
     ...
     */
    recordTrial(result: TrialResult | null, replaceIndex?: number): void;
    /**
     ...
     */
    consume<T extends SessionLogEntryType>(expectedType: T): Extract<SessionLogEntry, {
        type: T;
    }> | null;
...
declare class Timeline extends TimelineNode {
     ...
     */
    private getTimelineVariableOrder;
    /**
...
/**
 * Returns the seed that was most recently passed to (or generated by) `setSeed()`, or `undefined`
 * if `setSeed()` has never been called.
 */
declare function getSeed(): string;
...
declare const randomization_getSeed: typeof getSeed;
...
declare class ProgressBar {
     ...
     */
    private readonly onProgressSet?;
...
export { DataCollection, JsPsych, type JsPsychExtension, type JsPsychExtensionInfo, type JsPsychPlugin, ParameterType, type PluginInfo, type ResumeOptions, type StorageLike, type TrialType, initJsPsych };
