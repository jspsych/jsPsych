var jsPsychSketchpad=(function(a){"use strict";var d="2.1.0";const h={name:"sketchpad",version:d,parameters:{canvas_shape:{type:a.ParameterType.STRING,default:"rectangle"},canvas_width:{type:a.ParameterType.INT,default:500},canvas_height:{type:a.ParameterType.INT,default:500},canvas_diameter:{type:a.ParameterType.INT,default:500},canvas_border_width:{type:a.ParameterType.INT,default:0},canvas_border_color:{type:a.ParameterType.STRING,default:"#000"},background_image:{type:a.ParameterType.IMAGE,default:null},background_color:{type:a.ParameterType.STRING,default:"#ffffff"},stroke_width:{type:a.ParameterType.INT,default:2},stroke_color:{type:a.ParameterType.STRING,default:"#000000"},stroke_color_palette:{type:a.ParameterType.STRING,array:!0,default:[]},prompt:{type:a.ParameterType.HTML_STRING,default:null},prompt_location:{type:a.ParameterType.STRING,default:"abovecanvas"},save_final_image:{type:a.ParameterType.BOOL,default:!0},save_strokes:{type:a.ParameterType.BOOL,default:!0},key_to_draw:{type:a.ParameterType.KEY,default:null},show_finished_button:{type:a.ParameterType.BOOL,default:!0},finished_button_label:{type:a.ParameterType.STRING,default:"Finished"},show_clear_button:{type:a.ParameterType.BOOL,default:!0},clear_button_label:{type:a.ParameterType.STRING,default:"Clear"},show_undo_button:{type:a.ParameterType.BOOL,default:!0},undo_button_label:{type:a.ParameterType.STRING,default:"Undo"},show_redo_button:{type:a.ParameterType.BOOL,default:!0},redo_button_label:{type:a.ParameterType.STRING,default:"Redo"},choices:{type:a.ParameterType.KEYS,default:"NO_KEYS"},trial_duration:{type:a.ParameterType.INT,default:null},show_countdown_trial_duration:{type:a.ParameterType.BOOL,default:!1},countdown_timer_html:{type:a.ParameterType.HTML_STRING,default:'<span id="sketchpad-timer"></span> remaining'}},data:{rt:{type:a.ParameterType.INT},response:{type:a.ParameterType.STRING},png:{type:a.ParameterType.STRING},strokes:{type:a.ParameterType.COMPLEX,array:!0,nested:{action:{type:a.ParameterType.STRING},x:{type:a.ParameterType.INT,optional:!0},y:{type:a.ParameterType.INT,optional:!0},t:{type:a.ParameterType.INT,optional:!0},color:{type:a.ParameterType.STRING,optional:!0}}}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class n{constructor(e){this.jsPsych=e,this.is_drawing=!1,this.strokes=[],this.stroke=[],this.undo_history=[],this.mouse_position={x:0,y:0},this.draw_key_held=!1}trial(e,t,s){return this.display=e,this.params=t,this.current_stroke_color=t.stroke_color,this.init_display(),this.setup_event_listeners(),this.add_background_color(),this.add_background_image().then(()=>{s()}),this.start_time=performance.now(),this.set_trial_duration_timer(),new Promise((r,i)=>{this.trial_finished_handler=r})}init_display(){this.add_css();let e;if(this.params.canvas_shape=="rectangle")e=`
