...
describe('html-slider-response', function(){
	...
	test('should set min, max and step', function(){
		...
		expect(jsPsych.getDisplayElement().querySelector('#jspsych-html-slider-response-response-0').min).toBe('2');
		expect(jsPsych.getDisplayElement().querySelector('#jspsych-html-slider-response-response-0').max).toBe('10');
		expect(jsPsych.getDisplayElement().querySelector('#jspsych-html-slider-response-response-0').step).toBe('2');
	});
